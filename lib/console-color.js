...
export default class ColorConsole extends EventEmitter {
  ...
  print(str, options = {}) {
    ...
    // HACK: Retro Wildcat parser meets modern terminal smarts—now with ANSI sniffer!
    ...
    // Set return just to be safe (assuming 'return' means add newline—punny!)
    ...
    if (coloredStr.includes('${spinner}')) {
      ...
      if (options.return === false) {
        ...
        process.stdout.write('\x1b[0m');  // Neutral flush hack—noop but triggers display without \n.
      } else {
